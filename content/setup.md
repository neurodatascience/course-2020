...
{{< tab tabNum="1" >}} <!-- WINDOWS INSTRUCTIONS -->
...
Unfortunately, Docker for Windows is a mess.
How to use Docker on Windows varies dramatically depending on which version of Windows you have installed (e.g., Win10 Home versus Professional versus Enterprise) and which build of Windows you have
As such, we cannot develop a set of comprehensive installation instructions for Docker on Windows.
We recommend you try to follow either [these instructions](https://docs.docker.com/docker-for-windows/install/) (if you can) or [these instructions](https://docs.docker.com/toolbox/toolbox_install_windows/) (if you don’t have the requirements for the previous).

**PLEASE NOTE** that following the first set of instructions will disable VirtualBox on your computer. If you actively use VirtualBox we recommend following the second set of instructions.

{{< /tab >}}
{{< tab tabNum="2" >}} <!-- MAC OS INSTRUCTIONS -->
...
{{< /tab >}}
{{< tab tabNum="3" >}}  <!-- LINUX INSTRUCTIONS -->
